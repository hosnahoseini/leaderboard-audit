...
def test_gap_drop_search_matches_isrankingrobust_for_k1() -> None:
    ...
    for alpha in range(1, 6):
        payload = isRankingRobust(1, alpha, X, y)
        if payload[0] != -1:
    ...
    baseline_player_a, baseline_player_b, baseline_initial, baseline_final, baseline_rows = baseline_payload
    ...
    assert result["alpha"] == baseline_alpha
